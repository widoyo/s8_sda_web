...
import { deletePengumuman } from "../../../../services/pengumuman";
...
const ListPage = () => {
  ...
  const { pengumumanData, setParams, params, paginationInfo } =
    usePengumumanData();
  ...
  // Table Data
  const data = pengumumanData.map((item) => {
    return {
      ...item,
      action: (
  ...
  const handleDelete = async (id) => {
    try {
      ...
      toast.success("Pengumuman has been deleted");
    } catch (error) {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <Button onClick={handleAdd}>Tambah Pengumuman</Button>
      </div>
